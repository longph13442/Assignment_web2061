    ...
    render() {
        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <img src="http://res.cloudinary.com/vulong/image/upload/v1645343263/uploadimg/gjx3t9bhngoq3tkkicp4.png" width="5%" class="mx-3">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              ...
              <li><a href="/admin" class="nav-link px-2 text-white">pages</a></li>
